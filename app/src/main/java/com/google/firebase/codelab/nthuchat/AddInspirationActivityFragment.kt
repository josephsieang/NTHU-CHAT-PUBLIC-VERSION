...
import kotlinx.android.synthetic.main.fragment_add_inspiration_activity.*
import java.util.*

private const val TAG = "AddInspiration"

class AddInspirationActivityFragment : Fragment(), GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity!!.title = getString(R.string.addInspiration)
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        val contentView =  inflater.inflate(R.layout.fragment_add_inspiration_activity, container, false)
        ...
        mMapView = contentView.findViewById(R.id.mapViewAddInspirationActivity)
        ...
        when (item.getItemId()) {
            R.id.doneBtn -> {
                if(activityNameEt!!.text.toString() != "" && setDate && setGPS) {
                    ...
                    mFirebaseDatabaseReference = FirebaseDatabase.getInstance().reference.child("activity").child("innovation")
