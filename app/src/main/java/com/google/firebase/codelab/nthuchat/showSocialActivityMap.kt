...
private const val TAG = "showSocialActivityMap"

class showActivityMap : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun showActionBar() {
        ...
        activityTitle!!.text = getString(R.string.socialMap)
    }
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(nthu, 16.5F))
        ...
        mFirebaseDatabaseRef = FirebaseDatabase.getInstance().reference.child("activity").child("social")
