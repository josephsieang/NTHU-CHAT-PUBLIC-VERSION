...
private const val TAG = "infoActivityAmusement"

class InfoActivityAmusement : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_info_amusement)
        ...
        mFirebaseDatabaseReference = FirebaseDatabase.getInstance().reference.child("activity").child("amusement").child(activityUid.toString())
