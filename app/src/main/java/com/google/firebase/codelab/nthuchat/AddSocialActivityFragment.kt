...
import kotlinx.android.synthetic.main.fragment_add_social_activity.*
import java.text.SimpleDateFormat
import java.time.Month
import java.util.*

private const val TAG = "AddSocialActivity"

class AddSocialActivityFragment : Fragment(), GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity!!.title = getString(R.string.addSocialActivity)
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        val contentView =  inflater.inflate(R.layout.fragment_add_social_activity, container, false)
        ...
        mMapView = contentView.findViewById(R.id.mapViewAddSocialActivity)
...
//                        val dateFromString = format.parse(startDateFirebase)
//                        Log.d(TAG, "dataFromString: ${dateFromString}")
//                        Log.d(TAG, "compare date: ${(dateFromString < format.parse("2020-12-12 00:00:00"))}")
...
//
//        var result: Task<LocationSettingsResponse> = LocationServices.getSettingsClient(activity!!).checkLocationSettings(builder.build())
...
//                        try {
//                            var resolvable: ResolvableApiException =  exception as ResolvableApiException //casting in kotlin
        ...
        when (item.getItemId()) {
            R.id.doneBtn -> {
                if(activityNameEt!!.text.toString() != "" && setDate && setGPS) {
                    ...
                    mFirebaseDatabaseReference = FirebaseDatabase.getInstance().reference.child("activity").child("social")
