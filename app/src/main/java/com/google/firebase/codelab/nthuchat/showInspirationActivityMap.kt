...
private const val TAG = "showInspirationMap"

class showInspirationActivityMap : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun showActionBar() {
        ...
        activityTitle!!.text = getString(R.string.inspirationMap)
    }
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(nthu, 16.5F))
        ...
        mFirebaseDatabaseRef = FirebaseDatabase.getInstance().reference.child("activity").child("innovation")
                ...
                for(childSnapshot in dataSnapshot.children) {
                    ...
                    if(dateFromString > Calendar.getInstance().time) { //load activity that not expired
                        ...
                        mMap.setOnInfoWindowClickListener {
                            val intent = Intent(baseContext, InfoActivityInspiration::class.java)
