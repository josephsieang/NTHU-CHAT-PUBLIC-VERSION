...
private const val TAG = "infoActivitySocial"
...
class InfoActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mFirebaseDatabaseReference = FirebaseDatabase.getInstance().reference.child("activity").child("social").child(activityUid.toString())
