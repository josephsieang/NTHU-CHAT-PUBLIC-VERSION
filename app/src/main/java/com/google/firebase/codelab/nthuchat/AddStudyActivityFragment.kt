...
import kotlinx.android.synthetic.main.fragment_add_study_activity.*
import java.util.*

private const val TAG = "AddStudy"

class AddStudyActivityFragment : Fragment(), GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity!!.title = getString(R.string.addStudy)
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        val contentView =  inflater.inflate(R.layout.fragment_add_study_activity, container, false)
        ...
        mMapView = contentView.findViewById(R.id.mapViewAddStudyActivity)
        ...
        when (item.getItemId()) {
            R.id.doneBtn -> {
                if(activityNameEt!!.text.toString() != "" && setDate && setGPS) {
                    ...
                    mFirebaseDatabaseReference = FirebaseDatabase.getInstance().reference.child("activity").child("learning")
