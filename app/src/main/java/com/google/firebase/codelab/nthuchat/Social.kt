...
class Social : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity!!.title = getString(R.string.social)
    }
...
//        mapImage = contentView.findViewById(R.id.map_image) as CircleImageView
        ...
        val options = FirebaseRecyclerOptions.Builder<ActivityMessages>()
                .setQuery( mFirebaseDatabaseRef!!.child("activity").child("social"), ActivityMessages::class.java)
                .setLifecycleOwner(this)
                .build()


        mFirebaseAdapter = object : FirebaseRecyclerAdapter<ActivityMessages, Social.MessageViewHolder>(options) {

            override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Social.MessageViewHolder {
            ...
            override fun onBindViewHolder(viewHolder: Social.MessageViewHolder, position: Int, activityMessage: ActivityMessages) {
...
//                    viewHolder.bindView(activityMessageList.get(position))
                        ...
                        viewHolder.itemView.setOnClickListener {
                            ...
                            builder.setItems(options, DialogInterface.OnClickListener { dialogInterface, i ->
                                ...
                                if (i == 0) {
                                    ...
                                    //delete
                                    mFirebaseDatabaseRef!!.child("activity").child("social").addListenerForSingleValueEvent(object: ValueEventListener {
                                            ...
                                            for(childSnapshot in dataSnapshot.children) {
                                                if(childSnapshot.key == viewHolder.activityUid.text) {
                                                    ...
                                                    builder.setPositiveButton(getString(R.string.confirm)) { dialog, which ->
                                                        ...
                                                        mFirebaseDatabaseRef!!.child("activity").child("social").child(viewHolder.activityUid.text.toString()).removeValue()
    ...
    private fun loadMessages() {
        val messagesRef = mFirebaseDatabaseRef!!.child("activity").child("social")
...
//                mFirebaseAdapter.notifyItemRangeChanged(init, activityMessageList.size)
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        when(item!!.itemId) {
            R.id.mapBtn -> {
                val myIintent: Intent = Intent(activity, showActivityMap::class.java)
